...
//! - `UpperHex`
//!
//! Traits that you can derive are not automatically implemented for types generated by
//! `bitflags`. Many of these can be added yourself:
//!
//! ```
//! use bitflags::bitflags;
//!
...
//! ## `Borrow`
//!
//! The `Borrow` trait is not automatically implemented for the generated structs,
//! but it can be so long as you derive `Eq`, `Ord`, and `Hash`:
//!
//! ```
...
macro_rules! __impl_bitflags {
    (
        ...
        __impl_serde_bitflags!(InternalBitField: $T);
        ...
        impl $crate::_private::BitFlags for $BitFlags {
            type Bits = $T;
...
mod tests {
    ...
    fn test_set_ops_exhaustive() {
        ...
        let iter_test_flags =
            || (0..=0b111_1111_1111).map(|bits| Test::from_bits_preserve(bits));
    ...
    fn test_octal() {
        ...
        let extra = LongFlags::from_bits_preserve(0o5000000);
    ...
    fn test_lowerhex() {
        ...
        let extra = LongFlags::from_bits_preserve(0xe00000);
