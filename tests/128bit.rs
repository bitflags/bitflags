...
fn test_u128_bitflags() {
    ...
    assert_eq!(format!("{:?}", Flags128::A), "Flags128(A)");
    assert_eq!(format!("{:?}", Flags128::B), "Flags128(B)");
    assert_eq!(format!("{:?}", Flags128::C), "Flags128(C)");
    assert_eq!(format!("{:?}", Flags128::ABC), "Flags128(A | B | C | ABC)");
}
